...
INSERT IGNORE INTO `barang` (`id`, `kode_barang`, `nama_alat`, `merk`, `stock`, `created_date`, `created_by`, `update_date`, `update_by`) VALUES
	(1, 'AU-102', 'SKID', 'ccc', 2, '2020-06-09 04:35:10', 1, '2020-09-21 14:21:42', 1),
...
-- Dumping data for table db_balai_teknik.log_barang_keluar: ~2 rows (approximately)
/*!40000 ALTER TABLE `log_barang_keluar` DISABLE KEYS */;
INSERT IGNORE INTO `log_barang_keluar` (`id`, `kode_barang`, `nama_alat`, `tanggal_keluar`, `merk`, `no_serial`, `jumlah`, `tujuan`, `keterangan`, `created_date`, `created_by`) VALUES
	...
	(4, 'AU-102', 'SKID', '2020-09-21 00:00:00', 'ccc', '43543', 3, 'Raja Supplier1', 'rerererere', '2020-09-21 14:20:02', 1),
	(5, 'AU-102', 'SKID', '2020-09-21 00:00:00', 'ccc', '43543', 3, 'Raja Supplier1', 'tetetetete', '2020-09-21 14:21:42', 1);
...
INSERT IGNORE INTO `log_barang_masuk` (`id`, `kode_barang`, `nama_alat`, `tanggal_masuk`, `merk`, `no_serial`, `referensi`, `pengirim`, `jumlah`, `to`, `from`, `created_date`, `created_by`) VALUES
	...
	(24, 'AU-102', 'SKID', '2020-09-19 00:00:00', 'ccc', '43543', '', '101', 3, 6, 7, '2020-09-19 14:15:12', 1);
...
INSERT IGNORE INTO `pegawai` (`id`, `nip`, `password`, `nama`, `no_telp`, `email`, `status_pegawai`, `workgroup_id`, `user_type_id`, `created_date`, `created_by`, `update_date`, `update_by`) VALUES
	...
	(6, 4444, '$2y$10$KwhGngre5YSi/y6YT5hQwu1MPJZVOu80g2QMrnD1EzOWqoy620tES', 'Staff', '083873373051', 'staff@gmail.com', 'Honorer', 0, 2, '2020-07-27 13:19:24', 1, '2020-09-19 19:08:33', 0),
...
-- Dumping structure for table db_balai_teknik.pengirim
...
-- Dumping data for table db_balai_teknik.pengirim: ~2 rows (approximately)
/*!40000 ALTER TABLE `pengirim` DISABLE KEYS */;
INSERT IGNORE INTO `pengirim` (`id`, `nama_pengirim`, `created_date`, `created_by`, `update_date`, `update_by`) VALUES
	(101, 'Raja Supplier1', '2020-09-19 14:01:31', 1, '2020-09-19 14:08:17', 1),
	(102, 'Raja Distributor', '2020-09-19 14:08:27', 1, NULL, 0);
...
INSERT IGNORE INTO `users_type` (`id`, `nama`) VALUES
	(1, 'admininstrator'),
	(2, 'staff');
...
INSERT IGNORE INTO `workgroup` (`id`, `nama`, `unit_kerja`, `sub_bagian`, `created_date`, `created_by`, `update_date`, `update_by`) VALUES
